...
//////////////////////////////
/*pvpfw_cleanup_cleanAbandonded = true; // true or false, depending on whether you want abandoned vehicles to be deleted
pvpfw_cleanup_abandonedFromFaction = ["BLU_F","OPF_F","IND_F"]; // Vehicles from these factions will be cleaned up
pvpfw_cleanUp_abandonRadius = 200; // If no unit is closer than the specified distance, the removal countdown will start		** Org. = 200 **
pvpfw_cleanup_abandondTimer = 180; // The vehicle will be removed after the specified time		** Org. = 180 **
...
// Clean bodies //
//////////////////
/*pvpfw_cleanUp_bodyRadius = 10;	// Get this to work: Bodies will not suddenly be removed when looting them now. Added by Krycek.
pvpfw_cleanUp_bodyTimer = 120;	// Bodies will be removed after the specified amount of seconds ** Org. = 60 **
*/
/////////////////////////////////
//     Clean weaponholders     //
...
pvpfw_cleanUp_weaponHolderTimer = 300; // Weaponholders will be deleted after this time		** Org. = 10 **		// CAD - Set this to 300 so it stays as long as a dead players corpse.

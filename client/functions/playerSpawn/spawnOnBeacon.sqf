...
diag_log format["*** spawnOnBeacon Started ***"];
...
["=(dp)= Wasteland","Spawn Beacon",format ["%1:%3%2", floor(daytime), _mins, if(_mins < 10) then {"0"} else {""}]] spawn BIS_fnc_infoText;

diag_log format["*** spawnOnBeacon Finished ***"];
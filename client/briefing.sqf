...
<br/>
Rule 7:<br/>
- Only talk and type English in Side and Global, if you want to use your native language then simply make a Group. Anyone doing so will be warned, repeat offences will result in Kick and/or Ban<br/>
<br/>
Rule 8:<br/>
...
- Remember Independents vs Independants so dont complain if everyone kills you, if groups are disabled they are disabled for everyone.<br/>
"]
];
...
"
<br/>
Please register on our website at dp-clan.enjin.com and join CADeltas =(dp)= Wasteland Community to find out what we are up to and what our future plans for the Servers are. Suggestions for future versions of CADeltas =(dp)= Wasteland are always welcome<br/><br/>
...
<br/>
	Credit goes to Conroy & Terox for the Zeus AI Addon.<br/>
<br/>
"]
];

...
class RespawnSelectionDialog {
	...
	class controls {
		...
		{
			idc = -1;
			onButtonClick = "[0] execVM 'client\functions\playerSpawn\spawnAction.sqf'";
			text = "Random";
		...
		class TownButton0: w_RscButton
		{
			...
			onButtonClick = "[1,0] execVM 'client\functions\playerSpawn\spawnAction.sqf'";
			text = "";
		...
		class TownButton1: w_RscButton
		{
			...
			onButtonClick = "[1,1] execVM 'client\functions\playerSpawn\spawnAction.sqf'";
			text = "";
		...
		class TownButton2: w_RscButton
		{
			...
			onButtonClick = "[1,2] execVM 'client\functions\playerSpawn\spawnAction.sqf'";
			text = "";
		...
		class TownButton3: w_RscButton
		{
			...
			onButtonClick = "[1,3] execVM 'client\functions\playerSpawn\spawnAction.sqf'";
			text = "";
		...
		class TownButton4: w_RscButton
		{
			...
			onButtonClick = "[1,4] execVM 'client\functions\playerSpawn\spawnAction.sqf'";
			text = "";

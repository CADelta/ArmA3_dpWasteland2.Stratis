...
class VehicleManagement {
	...
	onLoad = "[4] execVM 'client\gui\adminPanel\populateVehicles.sqf'";
	...
	class controls {
		...
		class vehicleListBox: w_RscListbox
		{
			...
			onLBSelChanged="[1,_this select 1] execVM ""client\gui\adminPanel\importvalues.sqf"";";
		...
		class civButton: w_RscButton
		{
			...
			onButtonClick = "[0] execVM 'client\gui\adminPanel\populateVehicles.sqf'";
			text = "Cars/Trucks";
		...
		class heliButton: w_RscButton
		{
			...
			onButtonClick = "[1] execVM 'client\gui\adminPanel\populateVehicles.sqf'";
			text = "Helicopters";
		...
		class planeButton: w_RscButton
		{
			...
			onButtonClick = "[2] execVM 'client\gui\adminPanel\populateVehicles.sqf'";
			text = "Planes";
			x = 0.305 * safezoneW + safezoneX;
		...
		class tankButton: w_RscButton
		{
			...
			onButtonClick = "[3] execVM 'client\gui\adminPanel\populateVehicles.sqf'";
			text = "Tanks";
			x = 0.38 * safezoneW + safezoneX;
			y = 0.730 * safezoneH + safezoneY;
			w = 0.065 * safezoneW;
		...
		{
			idc = -1;
			onButtonClick = "[4] execVM 'client\gui\adminPanel\populateVehicles.sqf'";
			text = "Hacked Objects";
		...
		{
			idc = -1;
			onButtonClick = "execVM 'client\gui\adminPanel\deleteVehicle.sqf'";
			text = "Delete Object";
		...
		{
			idc = -1;
			onButtonClick = "execVM 'client\gui\adminPanel\deleteAllHackedVehicles.sqf'";
			text = "Delete All";

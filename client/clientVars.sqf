...
uniformArray = [	
	...
	["U_B_CTRG_1","CTRG Combat Uniform (UBACS)", 100,"uni"],								//New Uniform.
	["U_B_CTRG_2","CTRG Combat Uniform (UBACS2)", 100,"uni"],								//New Uniform.
	["U_B_CTRG_3","CTRG Combat Uniform (Tee)", 100,"uni"],									//New Uniform.
    ...
    //["U_O_SpecopsUniform_blk","Recon Fatigues (Black) [CSAT]", 100,"uni"],
...
//	Headgear:
	...
	//["H_HelmetB_plain_mcamo","Combat Helmet (Camo)", 150,"hat"],
	...
	//["H_HelmetSpecO_ocamo","Assassin Helmet (Hex)", 100,"hat"],		// Same as the Black version.
...
//	["H_BandMask_demon","Bandanna Mask (Demon)", 100,"hat"],
	...
	//["H_Shemag_tan","Shemag mask (Tan)", 50,"hat"],	// Same as the above.
	["H_Shemag_olive","Shemag (Olive)", 50,"hat"],
	["H_ShemagOpen_khk","Shemag (Khaki)", 50,"hat"],
	//["H_ShemagOpen_tan","Shemag (Tan)", 50,"hat"],	// Same as the above.
...
//	Belts and Vests:
	...
	["V_PlateCarrierL_CTRG","CTRG Plate Carrier Rig Mk.1 (Light)", 100,"vest"],		//New Vest.
	["V_PlateCarrierH_CTRG","CTRG Plate Carrier Rig Mk.2 (Heavy)", 150,"vest"],		//New Vest.
	...
	//["V_HarnessOGL_gry","LBV Grenadier Harness (Gray)", 150,"vest"],
...
//	Backpacks:
//	["B_HuntingBackpack","Hunting Backpack",100,"backpack"],
...
//	["B_TacticalPack_rgr","Tactical Backpack (Green)",200,"backpack"],
//  ["B_TacticalPack_mcamo","Tactical Backpack (MTP)",200,"backpack"],
//  ["B_TacticalPack_ocamo","Tactical Backpack (Hex)",200,"backpack"],
//  ["B_TacticalPack_blk","Tactical Backpack (Black)",200,"backpack"],
//  ["B_TacticalPack_oli","Tactical Backpack (Olive)",200,"backpack"],
...
//	Special Backpacks:	
	//["B_Mortar_01_support_F","Folded Mk6 Mortar Bipod",1000,"backpack"],			// Does not seem to work.
	//["B_HMG_01_support_F","Folded Tripod",1000,"backpack"],						// Does not seem to work.
	//["B_Mortar_01_weapon_F","Folded Mk6 Mortar Tube",1000,"backpack"],			// Does not seem to work.
	//["B_HMG_01_weapon_F","Dismantled Mk30 HMG",1000,"backpack"],					// Does not seem to work.
	//["B_HMG_01_high_weapon_F","Dismantled Mk30 HMG (Raised)",1000,"backpack"],	// Does not seem to work.
	//["B_AA_01_weapon_F","Static Titan Launcher (AA)",1000,"backpack"],			// Does not seem to work.
	//["B_AT_01_weapon_F","Static Titan Launcher (AT)",1000,"backpack"],			// Does not seem to work.
